...
//━━━━━━━━━━━━━━━[ HARI HARI ]━━━━━━━━━━━━━━━\\
        ...
        const isUrl = (url) => {
			...
			const reply = (teks) => {
			herman.sendMessage(from, teks, text, { thumbnail: gember, sendEphemeral: true, quoted: mek, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply:{title: `${jmn} WIB - ${week}`,body:"New Base RamzOfc",previewType:"PHOTO",thumbnail:gember,sourceUrl:`https://wa.me/p/6349482305092740/6285697662826`}}})
		}
		const reply2 = (teks) => {
...
return [...text.matchAll(/@([0-9]{5,16}|0)/g)].map(v => v[1] + '@s.whatsapp.net')
			...
			function addMetadata(packname, author) {	
				if (!packname) packname = 'Bot'; if (!author) author = 'By RamzOfc';	
...
const froxx = {
	 ...
	 message: { 
		"extendedTextMessage": {
                 "text": `New Base RamzOfc`,
                 "title": `New Base RamBot`,
...
//━━━━━━━━━━━━━━━[ BUAT BIO BOT ]━━━━━━━━━━━━━━━\\
runi = process.uptime() 
           herman.setStatus(`RamzOfc Aktif Selama ${kyun(runi)} `).catch((_)=>_);
